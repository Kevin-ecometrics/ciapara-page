...
import { useVanitasT } from "../../lib/i18n-vanitas";

const expo = [0.16, 1, 0.3, 1] as const;

export default function HeroVanitas() {
  const { locale } = useI18n();
  const tVanitas = useVanitasT(locale);
      ...
      <div className="relative z-10 h-full flex flex-col items-start justify-end text-left px-6 md:px-14 lg:px-20 pb-10 md:pb-14">
        ...
        <h1 className="flex flex-col items-start">
          <div className="overflow-hidden">
            ...
            >
              {tVanitas.hero.title1}
            </motion.span>
          </div>
          {tVanitas.hero.title2 && (
            <div className="overflow-hidden">
              <motion.span
                initial={{ y: "105%" }}
                animate={{ y: 0 }}
