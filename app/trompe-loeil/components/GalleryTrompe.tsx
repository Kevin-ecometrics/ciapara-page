...
/*
  ...
  Cada renglón es un grid de 12 cols independiente. Sin lightbox.
*/
const rows: Array<
...
> = [
  ...
  [
    { idx: 3, start: 1, span: 4, y: 20 },
    { idx: 4, start: 6, span: 4, y: 0 },
  ],
  // 5(L) 6(L)
  [
  ...
  // 21(P estrecho) 22(P) 23(P) — tres retratos
  [
    { idx: 21, start: 1, span: 2, y: 0 },
    { idx: 22, start: 4, span: 3, y: 20 },
    { idx: 23, start: 8, span: 3, y: 0 },
  ],
  // 24(P) 25(P)
  [
    { idx: 24, start: 2, span: 3, y: 0 },
    { idx: 25, start: 6, span: 3, y: 30 },
  ],
];
          ...
          <div className="sticky top-0 h-screen flex flex-col justify-center pl-12 border-l border-[#1A1916]/10">
            <AnimatePresence mode="wait">
              {active ? (
                ...
                >
                  <h3 className="text-sm text-[#1A1916]/80 text-xl leading-relaxed">
                    {active.alt}
                  </h3>
                </motion.div>
              ) : (
