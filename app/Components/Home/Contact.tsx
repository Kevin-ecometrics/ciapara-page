            ...
            <div className="mx-10 flex flex-col items-center justify-center">
                ...
                <div className="py-10 w-full">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center justify-center">
                        <div className="w-full max-w-full md:max-w-175 h-auto">
                            <iframe className="w-full h-100 rounded-lg shadow-lg" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3363.802415530763!2d-117.0391075243073!3d32.531423673767264!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80d949abacce16cf%3A0x19ff5488abe9a837!2sAv.%20Revoluci%C3%B3n%2C%20Tijuana%2C%20B.C.!5e0!3m2!1sen!2smx!4v1780952553811!5m2!1sen!2smx" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                        </div>
