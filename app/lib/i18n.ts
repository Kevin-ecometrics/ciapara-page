...
export const translations = {
    ...
    collections: {
        ...
        aboutBio: {
            hero: {
                title: "Enrique Ciapara Semblanza",
            },
            firstYears: {
                text: "ENRIQUE CIAPARA nació en la ciudad de Tijuana, BC bajo el signo de cáncer, en el año de 1972; de padre sonorense y madre chilango-bajacaliforniana. Como muchos artistas desde tempana edad se acerco a las artes, probando destreza en la música, tomando perfil definitivo en el dibujo y la pintura. En una ciudad en la que no había estudios artísticos profesionales, hasta hace pocos años, Enrique se formó en talleres libres, asistió al Colegio Soutwestern de Chula Vista y a los estudios de diferentes pintores y grabadores en Tijuana.",
            },
            mentors: {
                text: "A finales de la década de los años ochenta y principios de los noventa el artista Felipe Almada fue su mentor y el Nopal Centenario su pandilla y generación. En cuyo ambiente se desarrollaron los jóvenes que destacaron en teatro (Edward Coward), performance (Hugo Sánchez), literatura (Gerardo Navarro), activismo binacional (Carmela Castrejón) y en pintura (Ciapara). Después una influencia determinante en su formación fue la cercanía con el maestro Luís Moret y la maestra Marta Palau.",
            },
            europeFirst: {
                text: "En 1993 realizó su primera residencia en Europa, en la que viajó por España, Francia y Alemania, quedándose tres meses en Tarragona. Esta experiencia le dejó un gusto por la cultura mediterránea, desarrollando su natural habilidad gastronómica. A partir de 1996 se formaliza la demanda de su obra, logrando desde hace unos años una estabilidad de mercado regional en Ensenada-Tijuana-San Diego.",
            },
            europeSecond: {
            ...
            awards: {
                text: "Ha sido galardonado con premios y distinciones en diversos certámenes de arte como la III Bienal del Noroeste (1991), la Bienal Plástica de Baja California (1993, 2005) y recientemente obtuvo el primer lugar en la VI Bienal de Pintura Pedro Coronel (2019). Formó parte del Sistema Nacional de Creadores de Arte, FONCA, edición 2019-2022. Trabaja y radica desde la ciudad de Tijuana, México.",
            },
            cv: {
                title: "C.V. ENRIQUE CIAPARA.",
                body: `Tijuana, B.C., México 1972 —– FORMACIÓN —– 1991-94 taller de pintura
                con el mtro. Luis Moret, Tijuana, BC. 1992-93 Taller de dibujo y
                grabado con el mtro. Michel Shnor, Southwestern College, San Diego,
                CA. 1993 Residencia artística en el taller de Ramón Ferran, Reus,
                Tarragona, España. 1993-94 Taller de grabado con el mtro. Luis
                Lombardo, France Cultura, Tijuana, BC. 1995 Taller de pintura con el
                mtro. Roger Von Guten, Centro Cultural Tijuana, Tijuana, BC. —–
                EXPOSICIONES INDIVIDUALES —– 2013 Trompe-L'Œil, sala3 de El Cubo en
                el Centro Cultural Tijuana. 2010 Enrique Ciapara, el Take it easy, San
                Diego, CA. 2009 Obra sobre papel, Galería Arte256, Tijuana, BC. 2009
                La brigade, Manzanilla, Ensenada, BC. 2006 Pintura, Galería Arte256,
                Tijuana, BC. 2006 Ciapara, Galería La Caja, Tijuana, BC. 2005 Taller,
                Galería 4, Tijuana, BC. 2003 Cara y lugar, Pasillos del arte,
                Televisa, Tijuana, BC. 2001 Detritus, Centro Cultural Tijuana,
                Tijuana, BC. (catálogo). 2000 Habitual stops, Moctezuma Gallery, San
                Diego, CA. 1998 Enrique Ciapara, Galería 3art, Barcelona, España 1998
                Papers, La Rosa de foc, Barcelona, España. 1996 Crisálida, Centro
                Cultural Tijuana, Tijuana, BC. 1994 Ocio y trabajo, Instituto
                Veracruzano de Cultura, Veracruz, Ver. 1992 Galería Carmen Cuenca,
                Tijuana, BC. 1991 Ciapara, Rendezvous bar, Tijuana, BC. —–
                EXPOSICIONES COLECTIVAS —– 2011 Obra negra, una aproximación a la
                construcción de la cultura visual deTijuana, El Cubo, Centro Cultural
                Tijuana (catálogo). 2010 Sexta bienal internacional de Estandartes
                2010, Centro Cultural Tijuana (itinerante) (catálogo). 2010 Beyond the
                border, Feria internacional de arte contemporáneo, San Diego, CA. 2010
                Herma, Galería Vía Corporativo, Tijuana, BC. 2009 beyond the border,
                feria internacional de arte contemporáneo, San Diego, CA. 2008
                Acid-free, Galería Arte256, Tijuana, BC. 2008 Malamano, Exconvento del
                carmen, Guadalajara, JAL. 2007 Re-cuentos, Grand Hotel Tijuana,
                Tijuana, BC. 2006 strange new world, art and desing from tijuana,
                museo de arte contemporáneo de san diego, San Diego, CA, santa mónica
                museum of art y mexican institute in Washington DC (itinerante)
                (catálogo) 2005 XV bienal plástica de baja california, centro estatal
                de las artes, Mexicali, BC (itinerante) (catálogo) 2005 analogías de
                color y línea, centro estatal de las artes, Mexicali, BC (itinerante)
                (catálogo) 2004 international gallery, Solana beach, CA. 2003 baja
                terra, centro cultural tijuana, Tijuana, BC. 2001 pintura fresca,
                luckman gallery, Los Ángeles, CA. 2000 es2000 salón internacional de
                estandartes, centro cultural tijuana, Tijuana, BC. (itinerante)
                (catálogo) 1999 presencia nacional de creadores, centro nacional de
                las artes, México DF. 1997 tall a l'ull, galería moret, reus,
                tarragona, España 1997 bwa gallery, zielona gora, Polonia 1997
                certamen nacional de dibujo gregorio prieto, fundación gregorio
                prieto, cd real y caja de madrid, madrid, españa (itinerante)
                (catálogo) 1997 XVII Encuentro Nacional de Arte Joven, Pinacoteca de
                Nuevo León, Monterrey, N. L. 1997 VII encuentro nacional de arte
                joven, casa de la cultura de aguascalientes, ags (itinerante) 1997
                concurso bid de pintura joven en méxico, banco interamericano de
                desarrollo y centro cultural de la secretaría de hacienda y crédito
                público, México DF. (catálogo) 1996 ES96 salón internacional de
                estandartes, centro cultural tijuana, Tijuana, BC. (itinerante)
                (catalogo) 1996 all americans, porter-troupe gallery, San Diego, CA
                1995 X bienal plástica de baja california, instituto de cultura de
                Baja California, Mexicali, BC (itinerante) (catalogo). 1995 las
                delicias del plagio, galería de la ciudad, Tijuana, BC. 1995 V bienal
                del noroeste, culiacán sinaloa (itinerante) (catálogo) 1994
                poliloquio, centro cultural tijuana, Tijuana, BC. 1994 IV encuentro
                nacional de arte joven, casa de la cultura de aguascalientes, ags
                (itinerante) 1993 IV bienal del noroeste, culiacán sinaloa
                (itinerante) (catálogo) 1993 galería carmen cuenca, Tijuana, BC. 1992
                yokohama citizens gallery, yokohama, japón (catálogo) 1992 cova
                gallery, San Diego, CA 1992 galería río rita, Tijuana, BC. 1991 VIII
                bienal plástica de baja california, instituto de cultura de baja
                california, mexicali, bc (catálogo) 1991 III bienal del noroeste,
                culiacán sinaloa (itinerante) (catálogo) 1991 Tijuanenses, galería 19,
                Ensenada, BC. 1991 apuntes,bocetos,proyectos, galería carmen cuenca,
                Tijuana, BC. 1991 galería río rita, Tijuana, BC. 1991 elogio a
                tijuana, centro cultural tijuana, Tijuana, BC. 1991 el nopal
                centenario, Tijuana, BC. —– DISTINCIONES —– 2005 primer lugar en
                dibujo, XV bienal plástica de Baja California. 1997 mención
                honorífica, concurso bid de pintura joven en México. 1997 beca
                creadores con trayectoria, fondo estatal para la cultura y las artes.
                1995 primer lugar en grafica, X bienal plástica de Baja California.
                1995 mención honorífica en pintura, V bienal del noroeste. 1995 beca
                jóvenes creadores, fondo nacional para la cultura y las artes. 1993
                mención honorífica en pintura, IV bienal del noroeste. 1993 mención
                honorífica en dibujo, IV bienal del noroeste. 1991 tercer lugar en
                técnicas mixtas, VIII bienal plástica de Baja California. 1991 tercer
                lugar en obra en papel, III bienal del noroeste. —– ADQUISICIONES —–
                2005 Museo de Arte Contemporáneo de San Diego 2005 Instituto de
                Cultura de Baja California 2000 Museo de las Californias 1995
                Instituto de Cultura de Baja California 1991 Instituto de Cultura de
                Baja California 1991 Museo de Arte de Sinaloa —– OTRAS ACTIVIDADES —–
                2010 Diseño de etiqueta para vino La Niña Au Rouge, … 2008 Gestión y
                organización para la exhibición individual de la artista Marta Palau,
                El Mitote, Grand Hotel Tijuana, Tijuana, B. C. 2001 Diseño del espacio
                para la Compañía Jorge Domínguez, en la Tercera Muestra Internacional
                de Danza Cuerpos en Tránsito, en el Centro Cultural Tijuana, Tijuana,
                B. C. 2001 Diseño del espacio para Danzas Para Transitar el Mundo, de
                Jorge Domínguez, Teatro del Centro Nacional de las Artes, México, D.
                F. 1999 Portada de El Bilé y otras ensoñaciones, de Alejandra
                Camposeco, Fondo Ed. Tierra Adentro, México D. F. 1999 Portada y
                selección de dibujos de Tramoya , Revista de Teatro, No 61, editada
                por la Universidad Veracruzana, Veracruz, Mex. 1999 Diseño del espacio
                en la participación de Ricardo Peralta y Jorge Domínguez, en el
                Celebrate Dance Festival, Balboa Park, San Diego Ca. 1999 Dibujos de
                coreografía en papel, diseño del espacio, elementos escenográficos y
                vestuario, para la Compañía de Danza Jorge Domínguez, en Muestra
                Internacional de Danza Cuerpos en Tránsito, Centro Cultural Tijuana,
                Tij. B. C. 1992 Presentación con el grupo Tijuana´s Hottest Blues
                (voz), en el Ruse, San Diego, Ca. 1991 Portada de Desencuentros del
                Blues, de los Amores , de Francisco Morales, , Departamento editorial
                de la Universidad Autónoma de Baja California, Mexicali, B. C. 1991
                Selección de apuntes en dibujo para Hoja, del Taller de Poesía de
                Tijuana, Universidad Autónoma de Baja California.`,
            },
        },
        },
        en: {
    ...
    press: {
        ...
        cta: "Read more",
            ...
            aboutBio: {
                hero: {
                    title: "Enrique Ciapara Biography",
                },
                firstYears: {
                    text: "ENRIQUE CIAPARA was born in the city of Tijuana, Baja California, under the sign of Cancer, in 1972; his father was from Sonora and his mother was from Mexico City and Baja California. Like many artists, he was drawn to the arts from an early age, trying his hand at music before settling into drawing and painting as his definitive path. In a city that, until recently, had no professional art schools, Enrique trained in independent workshops, attended Southwestern College in Chula Vista, and studied in the studios of various painters and printmakers in Tijuana.",
                },
                mentors: {
                    text: "In the late 1980s and early 1990s, the artist Felipe Almada was his mentor, and El Nopal Centenario was his crew and generation — a milieu in which young artists came into their own in theater (Edward Coward), performance (Hugo Sánchez), literature (Gerardo Navarro), binational activism (Carmela Castrejón), and painting (Ciapara). Later, a determining influence on his formation was his close relationship with master artists Luis Moret and Marta Palau.",
                },
                europeFirst: {
                    text: "In 1993 he undertook his first residency in Europe, traveling through Spain, France, and Germany, and staying three months in Tarragona. This experience left him with a love for Mediterranean culture and further developed his natural gift for cooking. Starting in 1996, demand for his work became more formalized, and for several years now he has enjoyed a stable regional market across Ensenada–Tijuana–San Diego.",
                },
                europeSecond: {
                ...
                awards: {
                    text: "He has received awards and distinctions in various art competitions, including the III Bienal del Noroeste (1991) and the Bienal Plástica de Baja California (1993, 2005), and recently took first place at the VI Bienal de Pintura Pedro Coronel (2019). He was a member of the Sistema Nacional de Creadores de Arte, FONCA, 2019–2022 edition. He lives and works in the city of Tijuana, Mexico.",
                },
                cv: {
                    title: "C.V. — ENRIQUE CIAPARA",
                    body: `Tijuana, B.C., Mexico, 1972 —– TRAINING —– 1991–94 Painting workshop
                    with master Luis Moret, Tijuana, BC. 1992–93 Drawing and printmaking
                    workshop with master Michel Shnor, Southwestern College, San Diego,
                    CA. 1993 Artist residency at the studio of Ramón Ferran, Reus,
                    Tarragona, Spain. 1993–94 Printmaking workshop with master Luis
                    Lombardo, France Cultura, Tijuana, BC. 1995 Painting workshop with
                    master Roger Von Guten, Centro Cultural Tijuana, Tijuana, BC. —–
                    SOLO EXHIBITIONS —– 2013 Trompe-L'Œil, Sala 3 de El Cubo, Centro
                    Cultural Tijuana. 2010 Enrique Ciapara, el Take it Easy, San Diego,
                    CA. 2009 Obra sobre papel, Galería Arte256, Tijuana, BC. 2009 La
                    Brigade, Manzanilla, Ensenada, BC. 2006 Pintura, Galería Arte256,
                    Tijuana, BC. 2006 Ciapara, Galería La Caja, Tijuana, BC. 2005 Taller,
                    Galería 4, Tijuana, BC. 2003 Cara y Lugar, Pasillos del Arte,
                    Televisa, Tijuana, BC. 2001 Detritus, Centro Cultural Tijuana,
                    Tijuana, BC (catalogue). 2000 Habitual Stops, Moctezuma Gallery, San
                    Diego, CA. 1998 Enrique Ciapara, Galería 3art, Barcelona, Spain.
                    1998 Papers, La Rosa de Foc, Barcelona, Spain. 1996 Crisálida,
                    Centro Cultural Tijuana, Tijuana, BC. 1994 Ocio y Trabajo, Instituto
                    Veracruzano de Cultura, Veracruz, Ver. 1992 Galería Carmen Cuenca,
                    Tijuana, BC. 1991 Ciapara, Rendezvous Bar, Tijuana, BC. —– GROUP
                    EXHIBITIONS —– 2011 Obra Negra, una aproximación a la construcción
                    de la cultura visual de Tijuana, El Cubo, Centro Cultural Tijuana
                    (catalogue). 2010 Sexta Bienal Internacional de Estandartes 2010,
                    Centro Cultural Tijuana (traveling) (catalogue). 2010 Beyond the
                    Border, international contemporary art fair, San Diego, CA. 2010
                    Herma, Galería Vía Corporativo, Tijuana, BC. 2009 Beyond the
                    Border, international contemporary art fair, San Diego, CA. 2008
                    Acid-Free, Galería Arte256, Tijuana, BC. 2008 Malamano, Exconvento
                    del Carmen, Guadalajara, JAL. 2007 Re-Cuentos, Grand Hotel Tijuana,
                    Tijuana, BC. 2006 Strange New World: Art and Design from Tijuana,
                    Museum of Contemporary Art San Diego, San Diego, CA; Santa Monica
                    Museum of Art; and the Mexican Cultural Institute, Washington, DC
                    (traveling) (catalogue). 2005 XV Bienal de Artes Plásticas de Baja
                    California, Centro Estatal de las Artes, Mexicali, BC (traveling)
                    (catalogue). 2005 Analogías de Color y Línea, Centro Estatal de las
                    Artes, Mexicali, BC (traveling) (catalogue). 2004 International
                    Gallery, Solana Beach, CA. 2003 Baja Terra, Centro Cultural Tijuana,
                    Tijuana, BC. 2001 Pintura Fresca, Luckman Gallery, Los Angeles, CA.
                    2000 ES2000 Salón Internacional de Estandartes, Centro Cultural
                    Tijuana, Tijuana, BC (traveling) (catalogue). 1999 Presencia
                    Nacional de Creadores, Centro Nacional de las Artes, Mexico City.
                    1997 Tall a l'Ull, Galería Moret, Reus, Tarragona, Spain. 1997 BWA
                    Gallery, Zielona Góra, Poland. 1997 Certamen Nacional de Dibujo
                    Gregorio Prieto, Fundación Gregorio Prieto, Ciudad Real and Caja de
                    Madrid, Madrid, Spain (traveling) (catalogue). 1997 XVII Encuentro
                    Nacional de Arte Joven, Pinacoteca de Nuevo León, Monterrey, N.L.
                    1997 VII Encuentro Nacional de Arte Joven, Casa de la Cultura de
                    Aguascalientes, Ags. (traveling). 1997 Concurso BID de Pintura
                    Joven en México, Banco Interamericano de Desarrollo and Centro
                    Cultural de la Secretaría de Hacienda y Crédito Público, Mexico
                    City (catalogue). 1996 ES96 Salón Internacional de Estandartes,
                    Centro Cultural Tijuana, Tijuana, BC (traveling) (catalogue). 1996
                    All Americans, Porter-Troupe Gallery, San Diego, CA. 1995 X Bienal
                    de Artes Plásticas de Baja California, Instituto de Cultura de
                    Baja California, Mexicali, BC (traveling) (catalogue). 1995 Las
                    Delicias del Plagio, Galería de la Ciudad, Tijuana, BC. 1995 V
                    Bienal del Noroeste, Culiacán, Sinaloa (traveling) (catalogue).
                    1994 Poliloquio, Centro Cultural Tijuana, Tijuana, BC. 1994 IV
                    Encuentro Nacional de Arte Joven, Casa de la Cultura de
                    Aguascalientes, Ags. (traveling). 1993 IV Bienal del Noroeste,
                    Culiacán, Sinaloa (traveling) (catalogue). 1993 Galería Carmen
                    Cuenca, Tijuana, BC. 1992 Yokohama Citizens Gallery, Yokohama,
                    Japan (catalogue). 1992 Cova Gallery, San Diego, CA. 1992 Galería
                    Río Rita, Tijuana, BC. 1991 VIII Bienal de Artes Plásticas de Baja
                    California, Instituto de Cultura de Baja California, Mexicali, BC
                    (catalogue). 1991 III Bienal del Noroeste, Culiacán, Sinaloa
                    (traveling) (catalogue). 1991 Tijuanenses, Galería 19, Ensenada,
                    BC. 1991 Apuntes, Bocetos, Proyectos, Galería Carmen Cuenca,
                    Tijuana, BC. 1991 Galería Río Rita, Tijuana, BC. 1991 Elogio a
                    Tijuana, Centro Cultural Tijuana, Tijuana, BC. 1991 El Nopal
                    Centenario, Tijuana, BC. —– AWARDS —– 2005 First Place in Drawing,
                    XV Bienal de Artes Plásticas de Baja California. 1997 Honorable
                    Mention, Concurso BID de Pintura Joven en México. 1997 Established
                    Artist Grant, Fondo Estatal para la Cultura y las Artes. 1995
                    First Place in Printmaking, X Bienal de Artes Plásticas de Baja
                    California. 1995 Honorable Mention in Painting, V Bienal del
                    Noroeste. 1995 Young Creators Grant, Fondo Nacional para la
                    Cultura y las Artes. 1993 Honorable Mention in Painting, IV Bienal
                    del Noroeste. 1993 Honorable Mention in Drawing, IV Bienal del
                    Noroeste. 1991 Third Place in Mixed Media, VIII Bienal de Artes
                    Plásticas de Baja California. 1991 Third Place in Works on Paper,
                    III Bienal del Noroeste. —– ACQUISITIONS —– 2005 Museum of
                    Contemporary Art San Diego. 2005 Instituto de Cultura de Baja
                    California. 2000 Museo de las Californias. 1995 Instituto de
                    Cultura de Baja California. 1991 Instituto de Cultura de Baja
                    California. 1991 Museo de Arte de Sinaloa. —– OTHER ACTIVITIES —–
                    2010 Label design for La Niña Au Rouge wine. 2008 Management and
                    organization of the solo exhibition by artist Marta Palau, El
                    Mitote, Grand Hotel Tijuana, Tijuana, B.C. 2001 Stage design for
                    the Jorge Domínguez Dance Company at the Tercera Muestra
                    Internacional de Danza Cuerpos en Tránsito, Centro Cultural
                    Tijuana, Tijuana, B.C. 2001 Stage design for Danzas Para Transitar
                    el Mundo by Jorge Domínguez, Teatro del Centro Nacional de las
                    Artes, Mexico City. 1999 Cover art for El Bilé y Otras Ensoñaciones
                    by Alejandra Camposeco, Fondo Editorial Tierra Adentro, Mexico
                    City. 1999 Cover art and selected drawings for Tramoya, Revista de
                    Teatro, No. 61, published by Universidad Veracruzana, Veracruz,
                    Mex. 1999 Stage design for the participation of Ricardo Peralta
                    and Jorge Domínguez at the Celebrate Dance Festival, Balboa Park,
                    San Diego, CA. 1999 Choreography drawings on paper, stage design,
                    set elements, and costumes for the Jorge Domínguez Dance Company
                    at the Muestra Internacional de Danza Cuerpos en Tránsito, Centro
                    Cultural Tijuana, Tijuana, B.C. 1992 Performance with the group
                    Tijuana's Hottest Blues (vocals), at the Ruse, San Diego, CA. 1991
                    Cover art for Desencuentros del Blues, de los Amores by Francisco
                    Morales, Editorial Department of the Universidad Autónoma de Baja
                    California, Mexicali, B.C. 1991 Selection of drawings for Hoja, by
                    the Taller de Poesía de Tijuana, Universidad Autónoma de Baja
                    California.`,
                },
            },
  },
  fr: {
    ...
    collections: {
      ...
      items: [
        ...
        { title: "Trompe l'œil", description: "Les œuvres réunies dans cette exposition décrivent une limite entre toutes les possibilités qui se trouvent au-delà de ce que nous atteignons à voir, au-delà du paysage." },
    ...
    aboutBio: {
      ...
      firstYears: { text: "ENRIQUE CIAPARA est né à Tijuana, dans l'État de Basse-Californie, sous le signe du Cancer, en 1972 ; son père est originaire de Sonora et sa mère est à la fois de Mexico et de Basse-Californie. Comme beaucoup d'artistes, il s'est rapproché des arts dès son jeune âge, essayant la musique avant de trouver sa voie définitive dans le dessin et la peinture. Dans une ville qui, jusqu'à récemment, ne disposait pas d'écoles d'art professionnelles, Enrique s'est formé dans des ateliers libres, a fréquenté le Southwestern College de Chula Vista et a étudié dans les ateliers de divers peintres et graveurs de Tijuana." },
  ...
  ca: {
    ...
    collections: {
      ...
      items: [
        ...
        { title: "Trompe l'Œil", description: "Les obres reunides en aquesta exposició descriuen un límit entre totes les possibilitats que es poden trobar més enllà del que aconseguim a veure, més enllà del paisatge." },
        { title: "Detritus", description: "" },
    ...
    aboutBio: {
      ...
      firstYears: { text: "ENRIQUE CIAPARA va néixer a la ciutat de Tijuana, a Baja Califòrnia, sota el signe del Càncer, l'any 1972; el seu pare era de Sonora i la seva mare era de la Ciutat de Mèxic i de Baja Califòrnia. Com molts artistes, des de molt jove es va apropar a les arts, provant destresa en la música i prenent perfil definitiu en el dibuix i la pintura. En una ciutat que, fins fa pocs anys, no disposava d'estudis artístics professionals, Enrique es va formar en tallers lliures, va assistir al Southwestern College de Chula Vista i als estudis de diversos pintors i gravadors de Tijuana." },
...
export type Translations = {
    ...
    aboutBio: {
        hero: {title: string};
        firstYears: {text: string};
        mentors: {text: string};
        europeFirst: {text: string};
        europeSecond: {text: string};
        recentShows: {text: string};
        catalogs: {text: string};
        awards: {text: string};
