...
const news = [
  ...
  },
  {
    ...
    altEn: "El Sol de Tijuana newspaper covers Enrique Ciapara's Trompe-l'oeil exhibition at CECUT, 2013",
    altFr: "Le journal El Sol de Tijuana couvre l'exposition Trompe-l'œil d'Enrique Ciapara au CECUT, 2013",
    altCa: "El diari El Sol de Tijuana cobreix l'exposició Trompe-l'oeil d'Enrique Ciapara al CECUT, 2013",
    title: 'Presenta CECUT la exposicion "Trompe-L\'oeil" de Enrique Ciapara, bajo la curaduria Fernando Delmar',
    titleEn: "CECUT presents Enrique Ciapara's \"Trompe-L'oeil\" exhibition, curated by Fernando Delmar",
    titleFr: "Le CECUT présente l'exposition « Trompe-l'œil » d'Enrique Ciapara, sous la direction de Fernando Delmar",
    titleCa: "El CECUT presenta l'exposició «Trompe-l'oeil» d'Enrique Ciapara, sota la curaduría de Fernando Delmar",
  ...
  },
  {
    ...
    altEn: "CECUT press release on Ciapara's retrospective exhibition Trompe-L'oeil",
    altFr: "Communiqué de presse du CECUT sur l'exposition rétrospective Trompe-l'œil de Ciapara",
    altCa: "Nota de premsa del CECUT sobre l'exposició retrospectiva Trompe-l'oeil de Ciapara",
  ...
  },
  {
    ...
    altEn: "Installation view of Trompe-l'oeil exhibition by Enrique Ciapara in Tijuana",
    altFr: "Vue d'installation de l'exposition Trompe-l'œil d'Enrique Ciapara à Tijuana",
    altCa: "Vista d'instal·lació de l'exposició Trompe-l'oeil d'Enrique Ciapara a Tijuana",
  ...
  },
  {
    ...
    altEn: "Photograph of the Trompe-l'oeil exhibition in Sala 3 at El Cubo cultural center, Tijuana",
    altFr: "Photographie de l'exposition Trompe-l'œil dans la Salle 3 du centre culturel El Cubo, Tijuana",
    altCa: "Fotografia de l'exposició Trompe-l'oeil a la Sala 3 del centre cultural El Cubo, Tijuana",
    title: 'Presenta el CECUT la exposicion "Trompe-L\'oeil" de Enrique Ciapara',
    titleEn: "CECUT presents Enrique Ciapara's \"Trompe-L'oeil\"",
    titleFr: "Le CECUT présente le « Trompe-l'œil » d'Enrique Ciapara",
    titleCa: "El CECUT presenta el «Trompe-l'oeil» d'Enrique Ciapara",
  ...
  },
  {
    ...
    altEn: "Detail photograph of the Trompe-l'oeil exhibition by Enrique Ciapara, 2013",
    altFr: "Photographie de détail de l'exposition Trompe-l'œil d'Enrique Ciapara, 2013",
    altCa: "Fotografia de detall de l'exposició Trompe-l'oeil d'Enrique Ciapara, 2013",
  ...
  },
  {
    ...
    altEn: "Series of works on display in Enrique Ciapara's Trompe-l'oeil exhibition",
    altFr: "Série d'œuvres exposées dans l'exposition Trompe-l'œil d'Enrique Ciapara",
    altCa: "Sèrie d'obres exposades a l'exposició Trompe-l'oeil d'Enrique Ciapara",
  ...
  },
  {
    ...
    altCa: "Obres de la sèrie Trompe-l'oeil de Ciapara exposades a El Cubo",
