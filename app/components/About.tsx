...
// Bloque del LOREM + flecha animada/años + foto, y el botón "Más información"
// deshabilitados temporalmente — se reactivarán en el futuro.
const SHOW_ABOUT_HERO = false;
const SHOW_MORE_LINK = false;
...
function AboutHero({ t }: { t: Translations }) {
