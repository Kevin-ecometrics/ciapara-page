    ...
    <section className="pt-20 pb-48 bg-[#F6F2EC] overflow-hidden border-t border-b border-[#E4DFD8]">
      ...
      <div ref={wrapperRef} className="relative cursor-default">
        <div
          ...
          style={{
            background: "linear-gradient(to right, #F6F2EC, transparent)",
          }}
        />
        <div
          className="absolute right-0 top-0 bottom-0 w-20 z-10 pointer-events-none"
          style={{
            background: "linear-gradient(to left, #F6F2EC, transparent)",
          }}
        />
        ...
        <div className="overflow-hidden">
          ...
          >
            {items.map((name, i) => (
              ...
              >
                <span className="text-xs tracking-[0.2em] uppercase text-[#6B6660]">
                  {name}
                </span>
              </div>
            ))}
