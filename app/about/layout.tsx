...
export const metadata: Metadata = {
  ...
  keywords:
    "Enrique Ciapara, Ciapara, Arte Tijuana, Pintor tijuanense, Arte fronterizo, Grabado Tijuana, Arte Baja California, enrique ciapara exposicion trompe l'œil cecut, paisajes en transito museo pedro coronel ciapara, enrique ciapara errores exposicion 2019, obra negra centro cultural tijuana enrique ciapara, strange new world museum of contemporary art san diego ciapara, obras de enrique ciapara en el museo de arte contemporaneo de san diego, arte contemporaneo frontera tijuana san diego, generacion el nopal centenario tijuana arte",
  alternates: {
