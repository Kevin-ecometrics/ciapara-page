      ...
      >
        ...
        <figure className="h-100 w-[90%] shrink-0 overflow-hidden md:h-175 md:w-1/2 md:min-w-100 md:shrink">
          <img
            ...
            alt={isEn ? "Wall displaying a row of works from the Trompe-l'œil collection by Tijuana visual artist Enrique Ciapara, 2013" : "Pared con hilera de piezas de la colección titulada trompe l'œil del artista visual de tijuana Enrique Ciapara en 2013"}
            className="w-full h-full object-cover object-center"
            draggable={false}
          />
        </figure>
